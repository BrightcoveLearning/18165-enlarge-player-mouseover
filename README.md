...
# 18165-enlarge-player-mouseover
For more information about this sample see: https://support.brightcove.com/brightcove-player-sample-enlarge-player-mouseover.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The JavaScript for the plugin. An example, actual filename could be <strong>enlarge-player.js</strong>.</td>
    </tr>
    <tr>
      <td>plugin/plugin-name.css</td>
      <td>The CSS for the plugin. An example, actual filename could be <strong>enlarge-player.css</strong>.</td>
    </tr>
  </tbody>
</table>
